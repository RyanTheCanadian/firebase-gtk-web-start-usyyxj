...
rsvpYes.onclick = () => {// Get a reference to the user's document in the attendees collection
...
rsvpNo.onclick = () => {// Get a reference to the user's document in the attendees collection
 const userDoc = firebase.firestore().collection('attendees').doc(firebase.auth().currentUser.uid);
